...
import modelo.dao.ExpedienteFacade;
...
public class ExpedienteController implements Serializable {
    ...
    @EJB
    private modelo.dao.ExpedienteFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/vista").getString("ExpedienteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/vista").getString("ExpedienteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/vista").getString("ExpedienteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Expediente getExpediente(java.math.BigDecimal id) {
